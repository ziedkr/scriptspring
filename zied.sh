...
MS_HOME=/home/redhat/springlab/spring-boot-demo/target # <--- EDIT THIS LINE

# Actual file name of Micro Service (jar or war), 
# ms-service.war or something-0.0.1-SNAPSHOT.jar, etc.
MS_JAR=demo-0.0.1-SNAPSHOT.jar # <--- EDIT THIS LINE
...
JAVA_HOME=//usr/lib/jvm/java-1.8.0-openjdk-1.8.0.191.b12-1.el7_6.x86_64/jre/bin/java; # <-- EDIT THIS, Where is your JDK/JRE?
